...
public class BoardControllerImpl implements BoardController{
	...
	@ResponseBody
	public ResponseEntity addNewArticle(MultipartHttpServletRequest multipartRequest, HttpServletResponse resp)
			throws Exception {
	...
	@ResponseBody
	public ResponseEntity modArticle(MultipartHttpServletRequest multipartRequest, HttpServletResponse resp)
			throws Exception {
		multipartRequest.setCharacterEncoding("utf-8");
		Map<String,Object> articleMap = new HashMap<String,Object>();
		Enumeration enu = multipartRequest.getParameterNames();
	...
	@Override
	public ModelAndView removeArticle(int articleNO, HttpServletRequest req, HttpServletResponse resp)
			throws Exception {
		return null;
	}
